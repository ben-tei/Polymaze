...
/**
 * This class is used to solve a maze by returning the path to follow to solve
 * the maze. This static class contain one public method : solveMaze(Maze) This
 * method return an ArrayList<Point> which equals to all position contained in
 * the solution path
 * 
 * @author Loic
 * 
...
public class MazeSolver
{
	 ...
	 * 
	 * @param maze
	 *            Maze : The maze to resolve
	 * @return ArrayList<Point> : The list of all position from the starting
	 *         point to the ending point. The first point is the starting point,
	 *         the last the ending point. Point are like this : Point(x,y)
	 * @throws PolymazeException
	 *             if it's impossible to solve the maze
	 */
	 ...
	 * 
	 * @param x
	 *            int : x position of the cell trying to resolve
	 * @param y
	 *            int : y position of the cell trying to resolve
	 * @return boolean : <b>True</b> : if the current cell is on the solution
	 *         path. (from that point, one of his recursive call have reached
	 *         the end of the maze ) or this is directly the ending cell
	 *         <b>False</b> : if there is not unvisited connected cell and the
	 *         current cell is not the exit of the maze.
	 */
