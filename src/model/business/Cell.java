...
public class Cell {
	 ...
	 */
	public Cell(int positionX, int positionY, boolean wallNorth, boolean wallEast,
			boolean wallSouth, boolean wallWest) {
	...
	/**
	 * Initialize walls of this cell from a string of 4 characters composed of 0 and 1.
	 * @param strWalls:
