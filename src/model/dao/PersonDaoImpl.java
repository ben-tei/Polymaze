...
/**
 * This class manages links Person objects in the application
 * with table Person in the database
	...
	public Person createPerson(String name, String password) throws PolymazeException {
		...
		try {
			...
			if (personDaoImpl.getPersonByName(name) != null) {
				...
				PreparedStatement statement = connection.prepareStatement(queryCreatePerson, Statement.RETURN_GENERATED_KEYS);
				statement.setString(1, name);
