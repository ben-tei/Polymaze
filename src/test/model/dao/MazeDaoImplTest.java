...
public class MazeDaoImplTest
{
	...
	public void mazeDaoDriver00()
	{
		 ...
		 * assertEquals(createdDBTestMaze.getCreationDate(),
		 * testMaze.getCreationDate());
		 * assertEquals(createdDBTestMaze.getCreator().getId(),
		 * testMaze.getCreator().getId());
		 * assertEquals(createdDBTestMaze.getCreator().getName(),
		 * testMaze.getCreator().getName());
		 */
